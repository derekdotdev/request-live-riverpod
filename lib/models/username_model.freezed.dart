...
/// @nodoc
@JsonSerializable()
class _$_Username extends _Username {
  const _$_Username({required this.id, required this.username}) : super._();
...
abstract class _Username extends Username {
  const factory _Username(
      {required final String id, required final String username}) = _$_Username;
